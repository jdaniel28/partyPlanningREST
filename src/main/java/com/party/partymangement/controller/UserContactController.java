...
public class UserContactController {
	...
	public ResponseEntity<Object> postUserContact(@RequestBody UserContactModel model) {
		try {
			...
			throw new ResourceNotFoundException("Failed to add details to the User Contacts details");
		}
	}
	...
	public ResponseEntity<Object> updateUser(@RequestBody UserContactModel userContact) {
		...
		if (status) {
			...
			throw new ResourceNotFoundException("Failed to update the User Contact Details");
		}
	}
	...
	public ResponseEntity<Object> deleteUserContact(@PathVariable String contactId) {
		...
		if (status) {
			...
			throw new ResourceNotFoundException("Failed to delete User Contact Details");
		}
	}
